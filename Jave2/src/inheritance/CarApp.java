...
public class CarApp {
	public static void main(String[] args) {
		...
		/*
		 * //Object.toString() : 참조변수에 저장된 메모리 주소로 참조하여 "클래스명@메모리주소" 형식의 
		 * //문자열로 변환하여 반환하는 메소드 System.out.println("car.toString() = "+car.toString()); 
		 * //참조변수를 출력 처리할 경우 자동으로 Object 객체를 참조하여 toString() 메소드를 자동으로 호출 
		 * //=> 참조변수를 출력할 경우 toString() 메소드 호출을 생략 가능
