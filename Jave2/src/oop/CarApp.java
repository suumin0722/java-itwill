...
public class CarApp {
	public static void main(String[] args) {
		...
		// => 객체를 생성하면 객체 필드에는 기본값이 초기값으로 자동 저장
		...
		// => 참조변수는 동일한 객체의 메모리 주소를 저장하고 있으므로 같은 객체 참조
		Car carThree=carOne;
		...
		//은닉화 처리된 필드값을 제공받아 출력할 경우 에러가 발생되므로 Getter 메소드를 호출하여
		System.out.println("첫번째 자동차의 모델명 = "+carOne.getModelName());//객체 필드값 출력
		...
		System.out.println("두번째 자동차의 모델명 = "+carTwo.getModelName());//객체 필드값 출력
