...
//this : 메소드 내부에서 메소드를 호출한 객체의 메모리 주소(HashCode)를 저장하여 객체의 
//객체의 요소(필드 및 메소드)를 사용하기 위한 키워드
// => 메소드 내부에서 객체를 대신하여 필드 및 메소드를 사용하기 위해 제공되는 키워드
...
public class Member {
	...
	// => 기본 생성자를 작성하지 않으면 상속시 문제가 발생할 수 있으므로 기본 생성자는 작성하는 것을 권장
	//이클립스의 기능을 사용하여 기본 생성자를 생성하여 작성 가능
	...
	//[Alt]+[Shift]+[S] >> 팝업메뉴 - [O] >> 생성자 생성창 - 필드 선택 >> [Generate]클릭
