...
//클래스 또는 인터페이스 상수필드를 선언할 경우 발생될 수 있는 문제점
...
//해결하기 위해 열거형(EnumerateType)이라는 자료형(참조형)을 제공
public class InterfaceApp {
	public static void main(String[] args) {
		//인터페이스 내부에 선언된 상수필드값 출력
		...
		System.out.println("검색(InterfaceTwo.SEARC) = "+InterfaceTwo.SEARCH);
		System.out.println("======================================================");
		//상수필드와 같은 자료형의 변수를 생성하여 상수필드값을 저장
