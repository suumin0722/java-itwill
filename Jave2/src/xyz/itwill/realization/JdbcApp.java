...
public class JdbcApp {
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 * 
		//시스템 변경에 의해 기존 클래스를 새로운 클래스로 변경할 경우 새로운 클래스로
		//객체를 생성하여 새로운 클래스의 메소드 호출
		// => 기존 클래스와 관계를 맺고 있는 클래스도 새로운 클래스를 사용하기 위해 명령을 재선언
		// => 클래스 간의 결합도가 높기 때문에 유지보수의 효율성 감소
		...
		*/
		...
		//객체간의 결합도를 낮추기 위해 참조변수는 인터페이스를 이용해서 생성
