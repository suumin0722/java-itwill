...
<head>
	...
	<link href="<%=request.getContextPath()%>/resources/static/css/animate.min.css" type="text/css" rel="stylesheet" />
	<link href="<%=request.getContextPath()%>/resources/static/css/style.min.css" type="text/css" rel="stylesheet" />
	<link href="<%=request.getContextPath()%>/resources/static/css/style-responsive.min.css" type="text/css" rel="stylesheet" />
	<link href="<%=request.getContextPath()%>/resources/static/css/theme/default.css" type="text/css" rel="stylesheet" id="theme" />
	<!-- ================== END BASE CSS STYLE ================== -->
...
<body>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu media-list pull-right animated fadeInDown">
                            ...
                            <li class="media">
                                <a href="javascript:;">
                                    <div class="media-left"><img src="<%=request.getContextPath()%>/img/user-1.jpg" class="media-object" alt="" /></div>
                                    <div class="media-body">
                            ...
                            <li class="media">
                                <a href="javascript:;">
                                    <div class="media-left"><img src="<%=request.getContextPath()%>/img/user-2.jpg" class="media-object" alt="" /></div>
                                    <div class="media-body">
					...
					<li class="dropdown navbar-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
							<img src="<%=request.getContextPath()%>/img/user-13.jpg" alt="" /> 
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					<li class="nav-profile">
						<div class="image">
							<a href="javascript:;"><img src="<%=request.getContextPath()%>/img/user-13.jpg" alt="" /></a>
						</div>
						<div class="info">
							Sean Ngu
                            ...
                            <div data-scrollbar="true" data-height="225px">
                                <ul class="chats">
                                    <li class="left">
                                        ...
                                        <a href="javascript:;" class="image"><img alt="" src="<%=request.getContextPath()%>/img/user-12.jpg" /></a>
                                        <div class="message">
                                    ...
                                    <li class="right">
                                        ...
                                        <a href="javascript:;" class="image"><img alt="" src="<%=request.getContextPath()%>/img/user-13.jpg" /></a>
                                        <div class="message">
                                    ...
                                    <li class="left">
                                        ...
                                        <a href="javascript:;" class="image"><img alt="" src="<%=request.getContextPath()%>/img/user-10.jpg" /></a>
                                        <div class="message">
                                    ...
                                    <li class="left">
                                        ...
                                        <a href="javascript:;" class="image"><img alt="" src="<%=request.getContextPath()%>/img/user-14.jpg" /></a>
                                        <div class="message">
			    ...
			    <div class="col-md-4">
			        ...
			        <div class="panel panel-inverse" data-sortable-id="index-4">
                        ...
                        <ul class="registered-users-list clearfix">
                            <li>
                                <a href="javascript:;"><img src="<%=request.getContextPath()%>/img/user-5.jpg" alt="" /></a>
                            ...
                            <li>
                                <a href="javascript:;"><img src="<%=request.getContextPath()%>/img/user-3.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Ancient Caviar
                                    <small>Korean</small>
                                </h4>
                            ...
                            <li>
                                <a href="javascript:;"><img src="<%=request.getContextPath()%>/img/user-1.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Marble Lungs
                                    <small>Indian</small>
                                </h4>
                            ...
                            <li>
                                <a href="javascript:;"><img src="<%=request.getContextPath()%>/img/user-8.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Blank Bloke
                            ...
                            <li>
                                <a href="javascript:;"><img src="<%=request.getContextPath()%>/img/user-2.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Hip Sculling
                                    <small>Cuban</small>
                                </h4>
                            ...
                            <li>
                                <a href="javascript:;"><img src="<%=request.getContextPath()%>/img/user-6.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Flat Moon
                            ...
                            <li>
                                <a href="javascript:;"><img src="<%=request.getContextPath()%>/img/user-4.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Packed Puffs
                            ...
                            <li>
                                <a href="javascript:;"><img src="<%=request.getContextPath()%>/img/user-9.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Clay Hike
                                    <small>Swedish</small>
                                </h4>
	...
	<script src="<%=request.getContextPath()%>/resources/static/js/dashboard-v2.min.js"></script>
	<script src="<%=request.getContextPath()%>/resources/static/js/apps.min.js"></script>
	<!-- ================== END PAGE LEVEL JS ================== -->
