...
<body>
	...
	//브라우저가 실행된 클라이언트 플랫폼의 현재 날짜와 시간을 제공받아 태그내용을 변경하는 함수
	...
	//웹프로그램을 실행하는 서버 플랫폼의 현재 날짜와 시간을 제공받아 태그내용을 변경하는 함수
	// => 서버 플랫폼의 현재 날짜와 시간을 제공받아 사용하므로 모든 클라이언트에게 동일한 결과 제공 가능 
