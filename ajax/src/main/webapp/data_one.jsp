...
<body>
	...
	//[입력완료(GET)] 태그를 클릭한 경우 AJAX 엔진을 사용하여 [data_two.jsp] 문서를 GET 방식으로 요청하여
	//응답결과를 제공받아 태그 변경 처리
	...
	document.getElementById("getBtn").onclick=function() {
		...
		xhr.onreadystatechange=function() {
			//XMLHttpRequest 객체에 요청 웹프로그램의 응답결과를 전달받아 저장된 경우 
			if(xhr.readyState==4) {
		...
		//문제점)질의문자열에 URL 주소로 표현 불가능한 문자가 존재할 경우 400 에러코드 발생
