...
public class DoubleArrayApp {
	public static void main(String[] args) {
		//형식)자료형[][] 참조변수=new 자료형[행개수][열개수];
		// => 행개수: 2차원 배열에 존재하는 1차원 배열의 개수
		// => 열개수: 1차원 배열에 존재하는 요소의 개수
		...
		System.out.println("=========================================================");
		//1차원 배열의 요소에 개수가 선언되지 않은 2차원 배열 생성
		// => 2차원 배열에 1차원 배열의 메모리 주소를 저장할 수 있는 참조요소만 생성되며 null 저장
		...
		System.out.println("=========================================================");
		//1차원 배열을 생성하여 2차원 배열의 참조 요소에 저장
		//1차원 배열의 요소의 개수가 다른 2차원 배열 - 가변 배열
