...
public class DataInputStreamApp {
	public static void main(String[] args) throws IOException {
		//DataInputStream 클래스: 원시데이터를 원하는 자료형의 값으로 변환하여 제공받을
		//입력스트림을 생성하기 위한 클래스 
		...
		//DataInputStream.readInt() : 입력스트림의 원시데이터를 정수값으로 변환하여 반환하는 메소드
		int value1=in.readInt();
		
		//DataInputStream.readBoolean : 입력스트림의 원시데이터를 논리값으로 변환하여 반환하는 메소드
		boolean value2=in.readBoolean();
		
		//DataInputStream.readUTF() : 입력스트림의 원시데이터를 문자열로 변환하여 반환하는 메소드
