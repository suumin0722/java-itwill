...
public class StringApp {
	public static void main(String[] args) {
		...
		if(str1==str2) {
			System.out.println("str1 변수와 str2변수에 저장된 메모리 주소가 같습니다.");
		} else {
			System.out.println("str1 변수와 str2변수에 저장된 메모리 주소가 다릅니다.");
		}
		System.out.println("================================================================");
		...
		if(str1==str3) {
			System.out.println("str1변수와 str3변수에 저장된 메모리 주소가 같습니다.");
		} else {
			System.out.println("str1변수와 str3변수에 저장된 메모리 주소가 다릅니다.");
		}
		System.out.println("================================================================");
		//String.equals(String str) : String 객체에 저장된 문자열과 매개변수로 전달받은 String
		//문자열을 비교하여 다른 경우 [false], 같은 경우 [true]를 반환하는 메소드
		//비교 문자열이 영문자인 경우 대소문자를 구분
		if(str1.equals(str3)) {
			System.out.println("str1변수와 str3변수가 참조하는 String 객체의 문자열이 같습니다.");
		} else {
			System.out.println("str1변수와 str3변수가 참조하는 String 객체의 문자열이 다릅니다.");
		}
		System.out.println("================================================================");
		String str4="abc";
		
		if(str1.equals(str4)) {
			System.out.println("str1변수와 str4변수가 참조하는 String 객체의 문자열이 같습니다.");
		} else {
			System.out.println("str1변수와 str4변수가 참조하는 String 객체의 문자열이 다릅니다.");
		}
		System.out.println("================================================================");
		//String.equalsIgnoreCase(String str) : String 객체에 저장된 문자열과 매개변수로 전달받은 String
		//문자열을 비교하여 다른 경우 [false], 같은 경우 [true]를 반환하는 메소드
		...
		//문자열을 비교하여 String 객체에 저장된 문자열이 크면 양수를 반환하고 매개변수로
		//전달받은 String 객체의 문자열이 크면 음수를 반환하고 같으면 0을 반환하는 메소드
		//비교 문자열이 영문자인 경우 대소문자를 구분
