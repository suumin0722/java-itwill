...
public class InetAddressApp {
	public static void main(String[] args) throws UnknownHostException {
		...
		// => 호스트 이름을 알 수 없는 경우 UnknownHostException 발생
		//현재 사용중인 컴퓨터는 기볹적으로 [127.0.0.1]의 IP 주소(LoopBack IP 주소)가 제공되며
		...
		//InetAddress.getHostNam(): InetAddress 객체에 저장된 호스트 이름을 반환하는 메소드
		System.out.println("myComputer = "+myComputer.getHostName());

		
		//InetAddress.getHostAddress(): InetAddress 객체에 저장된 IP주소을 반환하는 메소드
