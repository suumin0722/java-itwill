...
public class PropertiesApp {
	public PropertiesApp() throws IOException {
		...
		//Class.getClassLoader() : 클래스(Java Source 파일)를 읽어 메모리에 저장한 ClassLoader 객체를 반환하는 메소드 
		//ClassLoader.getResourceAsStream(String name) : 매개변수로 프로젝트에 존재하는 패키지의 파일 경로를
		//제공받아 입력스트림을 생성하여 반환하는 메소드
		...
		//전달받은 맵키(Key)의 맵값(객체)을 반환하는 메소드
