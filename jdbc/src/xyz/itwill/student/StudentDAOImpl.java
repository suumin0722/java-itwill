...
// => 인터페이스를 상속받아 작성하는 것을 권장 - 메소드의 작성 규칙 제공받아 DAO 클래스 작성
// => DAO 클래스가 변경돼도 DAO클래스를 사용한 클래스에 영향을 최소화하여 유지보수의 효율성 증가하기 위해
//인터페이스를 상속받아 작성
// => 싱글톤 디자인 패턴을 적용하여 작성하는 것을 권장 - 프로그램에 하나의 객체만 제공하는 클래스

//STUDENT 테이블에 행을 삽입,변경,삭제,검색하는 기능의 메소드를 작성하기 위한 클래스
