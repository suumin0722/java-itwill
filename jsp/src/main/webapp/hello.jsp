...
<%
	//서버의 날짜와 시간을 저장한 Date 객체 생성
	Date now=new Date();
	//날짜와 시간의 패턴정보를 저장한 SimpeDateFormat 객체 생성
	SimpleDateFormat dateFormat=new SimpleDateFormat("yyyy년 MM월 dd일 HH시 mm분 ss초");
	//SimpeDateFormat 객체로 format() 메소드를 호출하여 매개변수로 전달받은 Date 객체를
	//SimpeDateFormat 객체에 저장된 날짜와 시간 패턴의 문자열로 변환하여 반환받아 저장
