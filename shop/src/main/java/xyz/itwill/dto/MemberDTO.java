...
이름            널?       유형            
------------- -------- ------------- 
MEMBER_NUM    NOT NULL NUMBER         - 회원번호 : 시퀀스의 증가값
...
ADDRESS1               VARCHAR2(200)  - 기본주소 : 사용자 입력값
ADDRESS2               VARCHAR2(100)  - 상세주소 : 사용자 입력값
JOIN_DATE              DATE           - 회원가입 날짜 : 시스템의 현재 날짜와 시간(SYSDATE)
UPDATE_DATE            DATE           - 회원변경 날짜 : 시스템의 현재 날짜와 시간(SYSDATE)
LAST_LOGIN             DATE           - 마지막 로그인 날짜 : 시스템의 현재 날짜와 시간(SYSDATE)
