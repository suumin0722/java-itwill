...
public class HewonAdvice {
	...
	public void afterThrowingLog() {
		System.out.println("### [after-throwing]핵심관심코드가 실행될 때 예외가 발생된 후에 삽입되어 실행될 횡단관심코드 ###");
	}
	
	public Object aroundLog(ProceedingJoinPoint joinPoint) throws Throwable {
		System.out.println("### [around]핵심관심코드가 실행 전에 삽입되어 실행될 횡단관심코드 ###");
		Object result = joinPoint.proceed();
		System.out.println("### [around]핵심관심코드가 실행 후에 삽입되어 실행될 횡단관심코드 ###");
		return result;
	}
} 