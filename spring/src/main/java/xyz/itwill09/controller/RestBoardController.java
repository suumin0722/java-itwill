...
public class RestBoardController {
	...
	//REST 기능을 제공하느 요청 처리 메소드는 @RequestMapping 어노테이션 대신 @GetMapping,
	...
	*/
	...
	//요청 URL 주소로 값을 전달하기 위해서는 @GetMapping 어노테이션의 value 속성값으로 {이름} 형식의 표현식 사용
	// => 요청 URL 주소로 제공된 값을 매개변수에 저장하기 위해 @PathVariable 어노테이션 사용
	//@PathVariable : 요청 URL 주소로 제공된 값을 매개변수에 저장하기 위한 어노테이션
	// => @GetMapping 어노테이션의 value 속성값으로 사용된 표현식의 읆과 매개변수의 이름을 동일하게 작성해야만
	//요청 URL 주소로 전달된 값을 매개변수에 저장 가능
	// => 
