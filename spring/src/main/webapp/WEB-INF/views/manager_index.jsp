...
<head>
	...
	<link href="resources/static/css/animate.min.css" type="text/css" rel="stylesheet" />
	<link href="resources/static/css/style.min.css" type="text/css" rel="stylesheet" />
	<link href="resources/static/css/style-responsive.min.css" type="text/css" rel="stylesheet" />
	<link href="resources/static/css/theme/default.css" type="text/css" rel="stylesheet" id="theme" />
	<!-- ================== END BASE CSS STYLE ================== -->
...
<body>
	...
	<script src="resources/static/js/dashboard-v2.min.js"></script>
	<script src="resources/static/js/apps.min.js"></script>
	<!-- ================== END PAGE LEVEL JS ================== -->
